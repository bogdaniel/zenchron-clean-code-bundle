...
class UseCaseInfrastructureViewHtmlGenerator extends ClassGenerator implements ClassGeneratorContract
{
    protected string $fileLocation = '';
    private string $templateName = '@ZenchronCleanCode/use_case_framework_html_view';
    private string $classNameSuffix = 'HtmlView';
