...
class UseCaseHtmlPresenterGenerator extends ClassGenerator implements ClassGeneratorContract
{
    protected string $fileLocation = 'Http';
    private string $templateName = '@ZenchronCleanCode/use_case_html_presenter';
    private string $classNameSuffix = 'HtmlPresenter';
