...
class UseCaseDomainResponseClassGenerator extends ClassGenerator implements ClassGeneratorContract
{
    protected string $fileLocation = 'Domain\UseCases';
    private string $templateName = '@ZenchronCleanCode/use_case_domain_response';
    private string $classNameSuffix = 'Response';
